package com.szegheomarci.carAds.model;
	...
	public String toText(String separator) {
		String details = this.getId() + separator + this.getTitle() + separator;
		details = details + this.getSubtitle() + separator + this.getPrice() + separator;
		details = details + this.getOdometer() + separator + this.getProductionDate() + separator;
		details = details + this.getEngine() + separator + this.getDealer() + separator;
		details = details + this.getCountry() + separator + this.getZipCity() + separator;
